namespace Forum.App
{
    ...
    internal class MenuController
    {
        ...
        private void RedirectToAddReply()
        {
            ...
            var addRerlyController = (AddReplyController)this.controllers[(int)MenuState.AddReply];
            addRerlyController.SetPostId(postDetailsController.PostId);
        ...
        private void LogInUser()
        {
            ...
            {
                if (controller is IUserRestrictedController userRectrictedController)
                {
                    userRectrictedController.UserLogIn();
                }
            }
        }
        ...
        private void LogOutUser()
        {
            foreach (var controller in this.controllers)
            {
                if (controller is IUserRestrictedController userRectrictedController)
                {
                    userRectrictedController.UserLogOut();
                }
            }
        }
    }
